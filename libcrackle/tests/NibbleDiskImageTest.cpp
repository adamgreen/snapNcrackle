...
TEST_GROUP(NibbleDiskImage)
{
    ...
    void writeZeroSectors(unsigned int startTrack, unsigned int startSector, unsigned int sectorCount)
    {
        ...
        NibbleDiskImage_InsertDataAsRWTS16(m_pNibbleDiskImage, pSectorData, &object);
        free(pSectorData);
    }
...
TEST(NibbleDiskImage, InsertTestSectorAt0_0AsRWTS16)
{
    ...
    object.track = 0;
    object.sector = 0;
    NibbleDiskImage_InsertDataAsRWTS16(m_pNibbleDiskImage, sectorData, &object);
...
TEST(NibbleDiskImage, ReadObjectFileAndWriteToImage)
{
    ...
    object.track = 0;
    object.sector = 0;
    NibbleDiskImage_InsertObjectFileAsRWTS16(m_pNibbleDiskImage, &object);
